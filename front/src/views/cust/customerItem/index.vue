        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="customerName">
                        <Input type="text" v-model="searchForm.customerName" placeholder="客户姓名" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="跟进内容" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="跟进人" clearable style="width: 120px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getCustomerItemList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
