package cn.ws.basics.log;

import cn.hutool.core.util.StrUtil;
import cn.hutool.http.useragent.UserAgent;
import cn.hutool.http.useragent.UserAgentUtil;
import cn.ws.basics.redis.RedisTemplateHelper;
import cn.ws.basics.utils.IpInfoUtil;
import cn.ws.basics.utils.ThreadPoolUtil;
import cn.ws.data.entity.Log;
import cn.ws.data.service.LogService;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(cn.ws.basics.log.SystemLog)")
