...
import cn.ws.test.entity.Student;
import cn.ws.test.service.IStudentService;
...
public class StudentController {
    ...
    public Result<IPage<Student>> getByPage(@ModelAttribute Student student ,@ModelAttribute PageVo page){
        ...
        if(!WsNullUtils.isNull(student.getName())) {
            qw.like("name",student.getName());
        }
        if(!WsNullUtils.isNull(student.getNumber())) {
            qw.like("number",student.getNumber());
        }
        if(!WsNullUtils.isNull(student.getSex())) {
            qw.like("sex",student.getSex());
        }
        if(!WsNullUtils.isNull(student.getSchool())) {
