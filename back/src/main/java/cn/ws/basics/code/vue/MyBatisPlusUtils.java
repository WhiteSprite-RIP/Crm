package cn.ws.basics.code.vue;

import cn.hutool.core.date.DateUtil;
import cn.ws.basics.code.bean.Entity;
...
public class MyBatisPlusUtils {
    ...
    private static final String author = "WhiteSprite";
    ...
    public static String camel2Underline(String camelContext) {
        if (WsNullUtils.isNull(camelContext)) {
            return "";
        }
    ...
    public static String name(String classTitle, boolean isFirstUpper){
        if(WsNullUtils.isNull(classTitle)){
            throw new WsException("类名的长度必须是正数");
        }
