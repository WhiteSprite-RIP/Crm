package cn.ws.basics.security.validate;

import cn.ws.basics.utils.ResponseUtil;
import cn.ws.basics.parameter.CaptchaProperties;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(WsNullUtils.isNull(userInputCode) || WsNullUtils.isNull(verificationCodeId)){
        ...
        if(WsNullUtils.isNull(codeAnsInRedis)){
