...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page){
        ...
        if(!WsNullUtils.isNull(sort)) {
            Sort.Direction direction = WsNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static String camel2Underline(String underlineContent) {
        if (WsNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }
