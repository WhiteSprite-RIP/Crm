package cn.ws.basics.parameter;
...
@Data
@Configuration
public class WsLoginProperties {
    ...
    public static final String HTTP_TOKEN_PRE = "WS_TOKEN_PRE:";

    public static final String USER_TOKEN_PRE = "WS_USER_TOKEN:";
}
